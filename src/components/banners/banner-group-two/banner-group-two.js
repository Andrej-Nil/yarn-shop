...
const BannerGroupTwo = () => {
    ...
    const img1 = {href: '#!', src: _baseSrc + 'l1.jpg', alt: 'img1', desc: 'Поробуйте "Saltera".', id: 'img1'};

    const img2 = {href: '#!', src: _baseSrc + 'l2.jpg', alt: 'img2', desc: 'Поробуйте "Мастерица".', id: 'img2'};

    const img3 = {href: '#!', src: _baseSrc + 'l3.jpg', alt: 'img3', desc: 'Поробуйте "Хлопковый шнур 5мм".', id: 'img3'};

    const img4 = {href: '#!', src: _baseSrc + 'l4.jpg', alt: 'img4', desc: 'Поробуйте "Рафия".', id: 'img4'};

    const img5 = {href: '#!', src: _baseSrc + 'r1.jpg', alt: 'img5', desc: 'Поробуйте "My baby".', id: 'img5'};

    const img6 = {href: '#!', src: _baseSrc + 'r2.jpg', alt: 'img6', desc: 'Поробуйте "Coco".', id: 'img6'};

    const img7 = {href: '#!', src: _baseSrc + 'r3.jpg', alt: 'img7', desc: 'Поробуйте "Bella".', id: 'img7'};

    const img8 = {href: '#!', src: _baseSrc + 'r4.jpg', alt: 'img8', desc: 'Поробуйте "Jeans".', id: 'img8'};
